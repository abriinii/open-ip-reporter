...
// Valid reports whether the geometry could describe a rack at all.
//
// Deliberately not bounded by any particular site's largest rack: this package
// is used wherever the tool is, and a limit taken from one site would reject
// another's racks outright. Checking a layout against what is plausible is the
// site package's job, not this one's.
